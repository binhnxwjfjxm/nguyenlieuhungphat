...
function buildProduct(productPlan: (typeof productPlans)[number]): Product | null {
  ...
  return {
    ...
    shortDescription: `Dòng ${groupName.toLowerCase()} thuộc ngành ${industryName.toLowerCase()}, phù hợp tham khảo cho cửa hàng, đại lý và đối tác F&B.`,
    description: `Thông tin giới thiệu cho dòng ${groupName.toLowerCase()} thuộc ngành ${industryName.toLowerCase()} trong danh mục Hưng Phát.`,
    origin: industryName,
    packaging: groupName,
    applications: [industryName, groupName, "Cửa hàng & đại lý"],
    features: [
      "Thuộc danh mục Hưng Phát đang giới thiệu",
      "Phù hợp tham khảo cho cửa hàng, đại lý và đối tác F&B",
      "Thông tin chi tiết được đối chiếu theo từng sản phẩm",
    ],
    specifications: [
